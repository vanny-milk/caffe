...
const Footer: React.FC = () => {
  return (
    <footer className="pm-footer bg-cafe-dark text-cafe-offwhite pt-12 pb-20">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          {/* Quick Links */}
          <div className="pm-footer-items">
            <h4 className="pm-h4 font-bold text-white uppercase tracking-widest text-sm mb-6">Explore</h4>
            <ul className="custom-links space-y-4 text-cafe-offwhite/60">
          ...
          {/* Support */}
          <div className="pm-footer-items">
            <h4 className="pm-h4 font-bold text-white uppercase tracking-widest text-sm mb-6">Service</h4>
            <ul className="custom-links space-y-4 text-cafe-offwhite/60">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="pm-h4 font-bold text-white uppercase tracking-widest text-sm mb-6">Stay Inspired</h4>
            ...
            <form className="relative" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button className="pm-button absolute right-2 top-2 bg-cafe-teal text-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-white hover:text-cafe-teal transition-all p-0 shadow-none border-none">
